...
`candidate-v14` — отключённый контур сбора BIS depth. Ни один из них не участвует
в live-стадии.
...
предыдущего server release. NBS войдёт в server gate только после rollout. Это проверка
